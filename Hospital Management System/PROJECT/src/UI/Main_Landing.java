 ...
 */
public class Main_Landing extends javax.swing.JPanel {
    JPanel workArea;
    MainAdmin admin;
    ...
    public Main_Landing(JPanel workArea, MainAdmin admin) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        CreateStaff createStaff = new CreateStaff(workArea, admin);
        workArea.add("CreateStaff",createStaff);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        HospitalDepartment d = new HospitalDepartment(workArea, admin);
        workArea.add("HospitalDepartment",d);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CreateDoctor cd = new CreateDoctor(workArea, admin);
        workArea.add("CreateDocto",cd);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        RevenueChart.createPieChartFromDatabase();
